...
const HeroSection = () => {
  return (
    <motion.section 
      className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-qalany-navy via-qalany-black to-qalany-navy"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold text-white mb-6 leading-tight">
            ...
            <span className="block text-transparent bg-clip-text bg-gradient-to-r from-qalany-orange to-yellow-400 animate-glow">
              Digital World
            </span>
          </h1>
        </motion.div>
        ...
        <motion.p 
          className="text-xl md:text-2xl text-qalany-light-gray mb-12 max-w-3xl mx-auto leading-relaxed"
          initial={{ y: 30, opacity: 0 }}
          animate={{ y: 0, opacity: 1 }}
          transition={{ delay: 0.4, duration: 0.8 }}
        >
          Empowering you to live fully, by making your digital world work for you. 
          Experience the future of digital empowerment with Qalany.
        </motion.p>
  ...
  const founders = [
    {
      ...
      title: "Founder & CEO",
      image: "https://images.unsplash.com/photo-1576558656222-ba66febe3dec?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80"
    },
    {
      name: "Tharindu De Silva", 
      title: "Co-Founder",
      image: "https://images.unsplash.com/photo-1666830070102-0c2f74d2e692?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80"
    }
  ];
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-lg text-gray-600 mb-8 leading-relaxed">
              ...
              At Qalany, we're building solutions that put you back in control, 
              making your digital experience intuitive, powerful, and truly personal.
            </p>
              ...
              >
                <div className="relative mb-6">
                  <img 
                    src={founder.image}
                    alt={founder.name}
                    className="w-40 h-40 rounded-full object-cover mx-auto shadow-premium group-hover:shadow-glow-navy transition-all duration-300"
                  />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Experience digital empowerment through our cutting-edge features designed to put you in complete control.
          </p>
        </motion.div>
